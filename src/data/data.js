  ...
  "Hall I": {
    Silver: {
      details: [
        ...
        { icon: <SilverStar />, text: "Free Wifi" },
        { icon: <SilverStar />, text: "Up-Lighting" },
        { icon: <SilverStar />, text: "Access to (4) 58” TVs" },
    ...
    Gold: {
      details: [
        ...
        { icon: <GoldStar />, text: "Free Wifi" },
        { icon: <GoldStar />, text: "Up-Lighting" },
        { icon: <GoldStar />, text: "Access to (4) 58” TVs" },
